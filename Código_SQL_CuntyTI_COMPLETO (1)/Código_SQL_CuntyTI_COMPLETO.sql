...
CREATE SCHEMA IF NOT EXISTS `cuntyti` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci ;
USE `cuntyti` ;
...
CREATE TABLE IF NOT EXISTS `cuntyti`.`clt` (
  ...
  INDEX `fk_clt_funcionario1_idx` (`funcionario_idFuncionario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cuntyti`.`clt_beneficio` (
  ...
  INDEX `fk_cb_beneficio` (`idBeneficio` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cuntyti`.`dependente` (
  ...
  INDEX `fk_dependente_clt1_idx` (`clt_idFuncionario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cuntyti`.`estagiario` (
  ...
  `funcionario_idFuncionario` INT NOT NULL,
  PRIMARY KEY (`idFuncionario`, `funcionario_idFuncionario`),
  INDEX `fk_estagiario_funcionario1_idx` (`funcionario_idFuncionario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cuntyti`.`estagiario_beneficio` (
  ...
  `idBeneficio` INT NOT NULL,
  PRIMARY KEY (`idFuncionario`, `idBeneficio`),
  INDEX `fk_eb_beneficio` (`idBeneficio` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cuntyti`.`pj` (
  ...
  `funcionario_idFuncionario` INT NOT NULL,
  PRIMARY KEY (`idFuncionario`, `funcionario_idFuncionario`),
  INDEX `fk_pj_funcionario1_idx` (`funcionario_idFuncionario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cuntyti`.`salario` (
  ...
  INDEX `fk_salario_funcionario1_idx` (`funcionario_idFuncionario` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `cuntyti`.`servico` (
  ...
  INDEX `fk_servico_pj` (`idFuncionario` ASC) VISIBLE,
...
(cpf, nomeSocial, logradouro, numero, bairro, cidade, estado, cep, sexo, status, dataAdmissao, dataNas, telefone, departamento_idDepartamento) VALUES
('11111111111', 'Joao Silva', 'Rua A', 100, 'Centro', 'Lavras', 'MG', '37200000', 'M', 'A', '2019-03-01', '1990-05-12', '998765432', 1),
('22222222222', 'Maria Souza', 'Rua B', 200, 'Jardim', 'Lavras', 'MG', '37200010', 'F', 'A', '2020-07-15', '1988-11-30', '998111222', 2),
('33333333333', 'Ana Oliveira', 'Rua C', 300, NULL, 'Lavras', 'MG', '37200020', 'F', 'A', '2021-01-10', '1995-02-25', '997333444', 1),
('44444444444', 'Carlos Pereira', 'Rua D', 400, 'Centro', 'Lavras', 'MG', '37200030', 'M', 'I', '2018-05-20', '1985-08-08', NULL, 3),
('55555555555', 'Beatriz Lima', 'Rua E', 500, 'Vila', 'Lavras', 'MG', '37200040', 'F', 'A', '2022-09-01', '1998-12-01', '996555666', 1),
('66666666666', 'Diego Santos', 'Rua F', 600, 'Centro', 'Lavras', 'MG', '37200050', 'M', 'D', '2017-02-18', '1983-04-19', '995777888', 4),
('77777777777', 'Felipe Costa', 'Rua G', 700, 'Jardim', 'Lavras', 'MG', '37200060', 'M', 'A', '2023-08-01', '2002-06-10', '994999000', 1),
('88888888888', 'Gabriela Rocha', 'Rua H', 800, 'Vila', 'Lavras', 'MG', '37200070', 'F', 'A', '2023-09-12', '2003-03-22', '993222111', 2),
('99999999999', 'Heitor Alves', 'Rua I', 900, NULL, 'Lavras', 'MG', '37200080', 'M', 'A', '2024-02-01', '2001-09-05', '992444333', 1),
('10101010101', 'Isabela Martins', 'Rua J', 1000, 'Centro', 'Lavras', 'MG', '37200090', 'F', 'A', '2024-03-15', '2002-12-30', '991666555', 5),
('12121212121', 'Julia Fernandes', 'Rua K', 1100, 'Jardim', 'Lavras', 'MG', '37200100', 'F', 'A', '2024-05-01', '2003-07-18', NULL, 1),
('13131313131', 'Lucas Mendes', 'Av X', 1200, 'Centro', 'Lavras', 'MG', '37200110', 'M', 'A', '2022-11-01', '1992-01-15', '990888777', 1),
('14141414141', 'Marina Dias', 'Av Y', 1300, 'Jardim', 'Lavras', 'MG', '37200120', 'F', 'A', '2023-01-20', '1991-10-10', '989000999', 4),
('15151515151', 'Nathan Gomes', 'Av Z', 1400, 'Vila', 'Lavras', 'MG', '37200130', 'M', 'A', '2023-06-05', '1989-03-03', '988111000', 1),
('16161616161', 'Olivia Castro', 'Av W', 1500, 'Centro', 'Lavras', 'MG', '37200140', 'F', 'A', '2024-01-10', '1994-08-21', '987222333', 4),
('17171717171','Paulo Ramos', 'Av V', 1600, 'Jardim', 'Lavras','MG','37200150','M','A','2022-04-25','1987-05-30','986333444', 3);
-- Nota: idFuncionario será gerado automaticamente de 1 a 16.


-- 4. TABELA: clt (Vincula aos IDs de funcionário correspondentes)
INSERT INTO clt (carteiraTrabalho, fgts, funcionario_idFuncionario) VALUES
('CTPS001', 'FGTS001', 1), 
('CTPS002', 'FGTS002', 2), 
('CTPS003', 'FGTS003', 3), 
('CTPS004', 'FGTS004', 4), 
...
INSERT INTO estagiario (curso, cargaHoraria, universidade, funcionario_idFuncionario) VALUES
('Ciencia da Computacao', 30, 'UFLA', 7), 
('Administracao', 20, 'UFLA', 8), 
('Sistemas de Informacao', 30, 'UFLA', 9), 
('Direito', 20, 'UFLA', 10), 
('Engenharia de Software', 40, 'UNILAVRAS', 11);
...
INSERT INTO pj (razaoSocial, funcionario_idFuncionario) VALUES
('Mendes Tech LTDA', 12), 
('Dias Consultoria ME', 13), 
('NG Solutions LTDA', 14), 
('Castro Design ME', 15), 
('Ramos Sistemas LTDA', 16);
...
(12, 'Desenvolvimento de API', 8000.00, '2025-06-30'), 
(12, 'Manutencao mensal de servidor', 2000.00, '2025-12-31'), 
(13, 'Consultoria de processos', 4500.00, '2025-08-15'), 
(14, 'Implantacao de ERP', 12000.00, '2025-09-30'), 
(15, 'Treinamento de equipe', 3000.00, '2025-07-20'), 
(15, 'Criacao de identidade visual', 3500.00, '2025-05-10');
...
FROM pj p
LEFT OUTER JOIN servico s ON p.funcionario_idFuncionario = s.idFuncionario;
...
WHERE departamento_idDepartamento IN (
    SELECT idDepartamento
    FROM departamento
    WHERE nomeDepartamento IN ('TI', 'Comercial')
);
...
WHERE NOT EXISTS (
    SELECT 1
    FROM servico s
    WHERE s.idFuncionario = p.funcionario_idFuncionario
);
...
FROM pj p
LEFT JOIN servico s ON p.funcionario_idFuncionario = s.idFuncionario
